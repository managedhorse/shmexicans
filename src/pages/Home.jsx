...
<>
  ...
  onClick={handleClick} // For broader compatibility
  onTouchStart={handleClick} // Specifically for touch devices
  ref={imageRef}
  src='/tswap.png'
  alt="Wobble"
...
/>
        ...
        <div onClick={() => navigate("/earn/spinner")} className='w-[50px] h-[50px]' style={{position: "absolute", bottom : "60px", right : "0px"}}>
          <img src={luckyWheel} className='w-full' alt='' />
        </div>

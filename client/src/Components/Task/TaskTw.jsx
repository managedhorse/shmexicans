...
const TaskTw = ({ showModal, setShowModal }) => {
  ...
  const handleVerify = async () => {
    ...
    const response = await fetch(
      `https://api.telegram.org/bot${import.meta.env.VITE_TELE_TOKEN}/getChatMember?chat_id=-1002156595848&user_id=${id}`
    );
  ...
  return (
    <>
      {showModal ? (
        <div className="fixed slackey-regular z-50 left-0 right-0 top-0 bottom-0 flex justify-center taskbg px-[16px] h-full">
